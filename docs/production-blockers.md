...
4. Final role matrix, guardian identity proofing, account approval flow, required MFA/AAL2 gates, and explicit approval before applying database-wide AAL2 restrictive RLS.
